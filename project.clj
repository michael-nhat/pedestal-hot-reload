...
(defproject my-pe-reload-service "0.0.1-SNAPSHOT"
  ...
  :profiles {:dev {:aliases {"run-dev" ["trampoline" "run" "-m" "my-pe-reload-service.server/run-dev"]}
                   :dependencies [[io.pedestal/pedestal.service-tools "0.5.11-beta-1"]]}
             :uberjar {:aot [my-pe-reload-service.server]}}
  :main ^{:skip-aot true} my-pe-reload-service.server)
